...
1365 297 1378 l5 22 400 0 400 0 -5 -22z"
        ...
        <div className="w-full md:w-auto md:border-0 md:bg-transparent md:p-0 md:pr-10">
          <ul className="border-border safe-bottom fixed bottom-0 left-0 z-[100] grid w-full grid-cols-3 gap-8 border-t bg-background pb-4 pt-3 md:relative md:flex md:w-auto md:border-none md:bg-transparent md:p-0 md:pt-0">
            {NAV_ITEMS.map((item) => (
