...
[Kohei](https://www.jujekebab.com/) was blogging from his website and I wanted
to try it out.
...
recommended me to keep the blog data in just files just because it's simpler.
Plus, if I ever want to switch platforms, I can just move my files. So I decided
to use this simple way.
